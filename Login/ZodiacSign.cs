...
namespace Login
{
    public class ZodiacSign
    {
        ...
        public ZodiacSign(eMonth i_Month, int i_Day)
        {
        ...
        private void initUserZodiacSign(eMonth i_Month, int i_Day)
        {
            switch (i_Month)
            {
                case eMonth.January:
                    Sign = i_Day >= 21 ? eZodiacSign.Aquarius : eZodiacSign.Capricorn;
                    break;
                case eMonth.February:
